...
public class XMLDocumentFragmentScannerImpl
    ...
    * protected String fDocumentSystemId;
    ...
    /** External entity. */
    private final net.sf.spindle.xerces.parser.xml.XMLEntityManager.ExternalEntity fExternalEntity = new XMLEntityManager.ExternalEntity();
    ...
    protected int scanEndElement() throws IOException, XNIException {
        ...
        if (fDocumentHandler != null ) {
            ...
            fDocumentHandler.endElement(fElementQName, augs);
        }
