...
public class SimpleDOMParserTests extends ValidatingDOMParserBase
{
    ...
    {
        DTDRegistry.registerTapestryDTD(SpecificationParser.TAPESTRY_DTD_3_0_PUBLIC_ID, "Tapestry_3_0.dtd");
    ...
    public void testGrammarPool() throws IOException
    {
        ...
        Reader reader =
            new BufferedReader(new InputStreamReader(getClass().getResourceAsStream("basicTapestryComponent.jwc")));
        try
        {
            parseAll(reader);
        } catch (SAXException e)
    ...
    public void testJ2EEGrammar() throws Exception
    {
        ...
        // parseAll forces a reset, which triggers the caching
        reader = new BufferedReader(new InputStreamReader(getClass().getResourceAsStream("basicTapestryComponent.jwc")));
        try
        {
            parseAll(reader);
        } catch (SAXException e)
