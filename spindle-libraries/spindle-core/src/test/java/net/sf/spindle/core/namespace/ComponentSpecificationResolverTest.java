...
import net.sf.spindle.core.util.Assert.AssertionFailedException;

import org.apache.tapestry.INamespace;
import org.apache.tapestry.spec.IComponentSpecification;
import org.easymock.MockControl;

public class ComponentSpecificationResolverTest extends AbstractTestCase
{
    ...
    {
        return new SuiteOfTestCases.Suite(ComponentSpecificationResolverTest.class);
    }

    public ComponentSpecificationResolverTest(String name)
    {
        super(name);
    }
