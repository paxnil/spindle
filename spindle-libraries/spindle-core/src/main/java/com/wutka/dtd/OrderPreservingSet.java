 ...
 * 
 */
public class OrderPreservingSet<E> implements Set<E> {

	List<E> fStore;

	public OrderPreservingSet() {
		super();
		fStore = new ArrayList<E>();
	}

	public OrderPreservingSet(Collection<? extends E> c) {
		this();
		fStore.addAll(c);
	}
	...
	public boolean addAll(Collection<? extends E> arg0) {
		Assert.isNotNull(arg0);
		for (Iterator<? extends E> iter = arg0.iterator(); iter.hasNext();) {
			E element = iter.next();
			add(element);
		}
		return true;
	...
	public boolean retainAll(Collection<?> collection) {
		...
		boolean changed = false;
		List<E> copy = new ArrayList<E>(fStore);
