...
public class SourceLocation implements ISourceLocation
{
    ...
    {
        return new SourceLocation(fLineNumber, fCharStart + offset >= fCharEnd ? fCharStart
                : fCharStart + offset, fCharEnd);
    }
    ...
    public boolean equals(Object obj)
    {
        ...
        {
            SourceLocation rhs = (SourceLocation) obj;
            return fLineNumber == rhs.fLineNumber && fCharStart == rhs.fCharStart
                    && fCharEnd == rhs.fCharEnd;
