...
/**
 * TODO this has de-evolved into a util class. if and when we go with Hivemind,
 * this stuff can all be pushed into services. ie. a Logger service to replace
 * the log calls, a CoreEvent service to replace CoreListeners, a
 * PreferenceService to obtain preference values
 * 
...
public class TapestryCore implements IPreferenceConstants {
	 ...
	 * The constructor.
	 */
	public TapestryCore(ILogger logger, ICoreListeners coreListeners,
			IPreferenceSource source) {
		Assert.isTrue(instance == null,
				"Can't init TapestryCore more than once!");
		instance = this;
		this.logger = logger;
