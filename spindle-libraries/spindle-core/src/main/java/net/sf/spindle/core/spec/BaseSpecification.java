 ...
 */
public abstract class BaseSpecification implements IIdentifiable, Locatable,
		LocationHolder {

	private static ThreadLocal<Stack<String>> INTERNAL_CALL_TRACKER = new ThreadLocal<Stack<String>>();

	protected static void beginInternalCall(String debugMessage) {

		Stack<String> internalStack = (Stack<String>) INTERNAL_CALL_TRACKER
				.get();
	...
	protected List<? extends Object> safeList(List<? extends Object> list) {
		if (list == null)
	...
	protected List<String> keys(Map<String, ? extends Object> map) {
		if (map == null)
			return Collections.emptyList();
