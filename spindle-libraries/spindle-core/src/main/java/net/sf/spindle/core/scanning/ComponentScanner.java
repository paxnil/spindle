...
import net.sf.spindle.core.spec.PluginParameterSpecification;
import net.sf.spindle.core.spec.PluginPropertySpecification;
import net.sf.spindle.core.spec.PluginReservedParameterDeclaration;
