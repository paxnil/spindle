...
public class IndentingWriter extends PrintWriter
{
     ...
     * @param out
     */
    public IndentingWriter(Writer out, boolean useTabsToIndent, int indentWidth, int initialIndent,
     ...
     * @param autoFlush
     */
    public IndentingWriter(Writer out, boolean autoFlush, boolean useTabsToIndent, int indentWidth,
            int initialIndent, String lineDelimiter)
    {
        super(out, autoFlush);
        init(useTabsToIndent, indentWidth, initialIndent, lineDelimiter);
    }
     ...
     * @param out
     */
    public IndentingWriter(OutputStream out, boolean useTabsToIndent, int indentWidth,
            int initialIndent, String lineDelimiter)
    {
        super(out);
        init(useTabsToIndent, indentWidth, initialIndent, lineDelimiter);
     ...
     * @param autoFlush
     */
    public IndentingWriter(OutputStream out, boolean autoFlush, boolean useTabsToIndent,
            int indentWidth, int initialIndent, String lineDelimiter)
    {
        super(out, autoFlush);
        init(useTabsToIndent, indentWidth, initialIndent, lineDelimiter);
    }

    private void init(boolean useTabsToIndent, int indentWidth, int initialIndent,
            String lineDelimiter)
    {
