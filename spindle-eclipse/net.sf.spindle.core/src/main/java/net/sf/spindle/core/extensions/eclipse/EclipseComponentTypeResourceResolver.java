 ...
 */
public class EclipseComponentTypeResourceResolver implements IComponentTypeResourceResolver
{
    ...
    public EclipseComponentTypeResourceResolver()
    {
        init();
    }
                ...
                try
                {
                    ...
                    if (!(obj instanceof IComponentTypeResourceResolver))
                    {
                        TapestryCore.log("could not create contribution '"
                                ...
                                + "' does not implement core.IComponentTypeResourceResolver");
                        continue;
                    }
                }
     ...
     * (non-Javadoc)
     * 
     * @see core.extensions.IComponentTypeResourceResolver#canResolve(org.eclipse.jdt.core.IType)
     */
     ...
     * (non-Javadoc)
     * 
     * @see core.extensions.IComponentTypeResourceResolver#doResolve(core.resources.ICoreResource,
     *      org.apache.tapestry.spec.IComponentSpecification)
     */
    public void doResolve(ICoreResource specificationLocation, IComponentSpecification componentSpec)
            throws SpindleExtensionException
    {
     ...
     * (non-Javadoc)
     * 
     * @see core.extensions.IComponentTypeResourceResolver#getStorage()
     */
