...
public class PagePathDialogCellEditor extends DialogCellEditor {
  ...
  protected Object openDialogBox(Control cellEditorWindow) {
    ...
    ChooseFromNamespaceDialog dialog =
      new ChooseFromNamespaceDialog(cellEditorWindow.getShell(), tproject, title, message, TapestryNamespaceLookup.ACCEPT_PAGES);
