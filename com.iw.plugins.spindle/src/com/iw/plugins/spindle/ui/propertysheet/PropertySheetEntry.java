  ...
  private List computeMergedPropertyDescriptors() {
    ...
    for (int i = 1; i < propertyDescriptorMaps.length; i++) {
      ...
      for (int j = 0; j < ids.length; j++) {
        ...
        !(
          (IPropertyDescriptor) intersection.get(ids[j])).isCompatibleWith(
  ...
  */
  ...
  public void dispose() {
    ...
    if (childEntries != null)
      for (int i = 0; i < childEntries.length; i++) { // an error in a property source may cause refreshChildEntries
  ...
  public String getErrorText() {
    return errorText;
      ...
      * Method declared on IPropertySheetEntry.
      */
  public String getFilters()[] { return descriptor.getFilterFlags();
  } /* (non-Javadoc)
    * Method declared on IPropertySheetEntry.
    */
  ...
  public boolean hasChildEntries() {
    if (childEntries != null && childEntries.length > 0)
      return true;
    else // see if we could have entires if we were asked
  ...
  public void resetPropertyValue() {
    ...
    if (change)
      refreshValues();
        ...
        * Set the descriptor.
        */
  private void setDescriptor(IPropertyDescriptor newDescriptor) { // if our descriptor is changing, we have to get rid
