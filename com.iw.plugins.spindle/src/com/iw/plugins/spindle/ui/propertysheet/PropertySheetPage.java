...
public class PropertySheetPage extends Page implements IPropertySheetPage {
	...
	private void makeActions() {
		...
		defaultsAction.setToolTipText("Restore Default Values");//PropertiesMessages.getString("Page.defaultToolTip")); //$NON-NLS-1$
		...
		filterAction.setToolTipText("Filter Properties");//PropertiesMessages.getString("Page.filterToolTip")); //$NON-NLS-1$
		...
		categoriesAction.setToolTipText("Show Categories");//PropertiesMessages.getString("Page.categoriesToolTip")); //$NON-NLS-1$
