...
public class ComponentAliasParameterViewer extends HelpViewer {
  ...
  public ComponentAliasParameterViewer(String parameter, HashMap precomputedMap) {
  ...
  public String getViewerTitle() {
    return "Information about parameter: " + parameter;
  }
  ...
  private void createItems() {
    ...
    while (iter.hasNext()) {
      ...
      buffer.append("\n");
      (
        (PluginParameterSpecification) componentModel.getComponentSpecification().getParameter(
