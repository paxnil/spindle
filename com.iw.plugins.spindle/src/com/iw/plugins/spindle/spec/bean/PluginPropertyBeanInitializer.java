...
public class PluginPropertyBeanInitializer
  ...
  public PluginPropertyBeanInitializer deepCopy() {
  	return new PluginPropertyBeanInitializer(getPropertyName(), getOriginalPropertyPath());
  }
  ...
  public String toString() {
    ...
    String value = getOriginalPropertyPath();
    ...
    if ("property".equals(key)) {
      ...
      if ("".equals(newName.trim())) {
        ...
        PluginPropertyBeanInitializer copy =
          new PluginPropertyBeanInitializer(newName, getOriginalPropertyPath());
  ...
  public Object getPropertyValue(Object key) {
    if ("property".equals(key)) {
      ...
      return getOriginalPropertyPath();
    }
    return null;
  }
