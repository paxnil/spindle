...
public abstract class NewTapestryElementWizardPage extends WizardPage {
  ...
  protected void updateStatus(IStatus status) {
    ...
    //    System.out.println("%%%%%%%%%%%%%%%%%%%%%%%%%%%%");
    //    System.out.print("Current Status = " + fCurrStatus.getSeverity());
    //    System.out.println(" message = " + fCurrStatus.getMessage());
    //    System.out.print("New Status = " + status.getSeverity());
    //    System.out.println(" message = " + status.getMessage());
    fCurrStatus = statusContainer.getStatus(true);
    //    System.out.print("More Severe = " + fCurrStatus.getSeverity());
    //    System.out.println(" message = " + fCurrStatus.getMessage());
