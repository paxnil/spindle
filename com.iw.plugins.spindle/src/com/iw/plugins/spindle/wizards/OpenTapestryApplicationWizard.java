 ...
 * @version $Id$
 */
public class OpenTapestryApplicationWizard extends OpenTapestryWizard {

  public OpenTapestryApplicationWizard() {
    super();
  }

  public OpenTapestryApplicationWizard(String label, Class[] acceptedTypes) {
