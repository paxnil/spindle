...
public class NewLibraryProjectWizard extends AbstractNewProjectWizard {
  ...
  public NewLibraryProjectWizard() {
    super();
   setWindowTitle("New Tapestry Library Project");
  ...
  public NewTapestryProjectPage createTapestryPage(IWorkspaceRoot root) {
    return new LibraryWizardPage(root);
  }
  ...
  public void addPages() {
    super.addPages();
    mainPage.setTitle("Library Project");
