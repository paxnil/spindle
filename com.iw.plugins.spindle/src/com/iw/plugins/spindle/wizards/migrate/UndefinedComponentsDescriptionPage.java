 ...
 * All Rights Reserved.
 */
public class UndefinedComponentsDescriptionPage extends WizardPage {
   ...
   * @param name
   */
  public UndefinedComponentsDescriptionPage(String name, MigrationContext context) {
    super(name);

    this.setImageDescriptor(
      ImageDescriptor.createFromURL(TapestryImages.getImageURL("application32.gif")));
    this.setDescription("There are components in the project that are not defined in the Application/Library");
  ...
  private String getWelcomeMessage() {
    String resource = "undefinedComponents.xml";
