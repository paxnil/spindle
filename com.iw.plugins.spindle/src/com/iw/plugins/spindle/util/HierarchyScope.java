 ...
 * @version $Id$
 *
 * This is kludge to limit the built in hierachy scope so its limited to the current project!
 * Expect this to break when post 2.0.1 releases of Eclipse appear!
 *
...
public class HierarchyScope extends AbstractSearchScope {
	 ...
	 */
	public HierarchyScope(IType type, IJavaProject project) throws JavaModelException {
		this.initialize();
		fHierarchy = type.newTypeHierarchy(project, null);
		buildResourceVector();
