...
import com.iw.plugins.spindle.editors.multi.Form;
...
public class OverviewLibFormPage extends FormPage
{

    OverviewForm form;

    public OverviewLibFormPage(MultiPageSpecEditor editor, String title)
    {
        super(editor, title);
    }
    ...
    {
        // TODO   return new LibraryContentOutlinePage(this);
        return null;
    }

    protected FormSection getGeneralSection(FormPage page)
    {
        return new OverviewLibGeneralSection(page);
    }

    protected class OverviewForm extends Form
    {

        //    private OverviewAlertSection alertSection;
        private FormSection generalSection;
        ...
        public OverviewForm(FormPage page)
        {
            super(page);
        }
