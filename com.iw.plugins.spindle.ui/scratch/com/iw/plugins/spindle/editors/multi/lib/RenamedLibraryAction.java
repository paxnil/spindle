...
public class RenamedLibraryAction extends Action {
  ...
  private void configure() throws CoreException {
    ...
    libSpecification = (ILibrarySpecification) model.getSpecification();
  ...
  private void performChangeInModel(
    ...
    for (Iterator iter = changes.iterator(); iter.hasNext();) {
      ...
      PluginComponentSpecification modelSpec = (PluginComponentSpecification) model.getSpecification();
  ...
  private List findComponentPartsToUpdate(TapestryComponentModel component) {
    ...
    PluginComponentSpecification componentSpec = (PluginComponentSpecification) component.getSpecification();
