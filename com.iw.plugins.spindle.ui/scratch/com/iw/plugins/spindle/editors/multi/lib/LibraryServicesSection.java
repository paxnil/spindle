...
public class LibraryServicesSection extends AbstractPropertySheetEditorSection implements IModelChangedListener
{
    ...
    public void update(BaseTapestryModel model)
    {
        ...
        try
        {
            ...
            ILibrarySpecification framework = (ILibrarySpecification) mgr.getDefaultLibrary().getSpecification();
            ...
            for (Iterator iter = defaultServices.iterator(); iter.hasNext();)
            {
                ...
                ServiceHolder holder = new ServiceHolder(defaultName, framework.getServiceClassName(defaultName));
        ...
        public IPropertyDescriptor[] getPropertyDescriptors()
        {
            return new IPropertyDescriptor[] {
                ...
                new TypeDialogPropertyDescriptor(
                    ...
                    "net.sf.tapestry.IEngineService"),
                };
        }
    ...
    protected void updateButtons(Object selected)
    {
        ...
        {
            deleteButton.setEnabled(isEditable && selected != null && spec.canDeleteService(holder.identifier));
        }
        inspectButton.setEnabled(isEditable && holder != null);
        revertButton.setEnabled(isEditable && holder != null && spec.canRevertService(holder.identifier));
    }
