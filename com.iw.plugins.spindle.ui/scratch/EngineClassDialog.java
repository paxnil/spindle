...
public class EngineClassDialog extends TypeDialogField
{
    ...
    public void init(PackageDialogField packageChooser, IRunnableContext context)
    {
        ...
        setTextValue(UIPlugin.getString("TapestryEngine.defaultEngine"));
    }
    ...
    protected IStatus typeChanged()
    {
        ...
        try
        {
            ...
            {
                throw new Error("tapestry engine base type: " + engineBaseTypeName + " does not exist in properties!");
            }
            ...
            if (engineBaseType.isInterface())
            {
                ...
                {
                    status.setWarning(
                        UIPlugin.getString(name + ".warning.EngineDoesNotImplementInterface", engineBaseTypeName));
                    return status;
                }
            } else
            {
                ...
                if (!match)
                {
                    ...
                    {
                        status.setError(UIPlugin.getString(name + ".warning.EngineClassNotExtend", engineBaseTypeName));
                    }
                    return status;
                }
