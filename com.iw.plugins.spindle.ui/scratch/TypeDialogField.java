...
public class TypeDialogField extends StringButtonField
{
    ...
    protected IStatus typeChanged()
    {
        ...
        {
            status.setError(UIPlugin.getString(name + ".error.QualifiedName"));
            return status;
        }
        ...
        if (pack != null)
        {
            ...
            if (cu.exists())
            {
                status.setError(UIPlugin.getString(name + ".error.TypeNameExists"));
                return status;
            }
        }
        return status;
    ...
    private IType chooseType()
    {
        ...
        try
        {
            ...
            dialog.setMessage(
                hierarchyRoot == null ? message : message + " (extends/implements " + hierarchyRoot + ")");
