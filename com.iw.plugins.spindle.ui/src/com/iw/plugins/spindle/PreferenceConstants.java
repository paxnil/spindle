...
public interface PreferenceConstants
{
  ...
  String EDITOR_FOLDING_ENABLED = UIPlugin.PLUGIN_ID + ".EDITOR_FOLDING_ENABLED";
  
  String RECONCILE_TEMPLATE_EDITOR = UIPlugin.PLUGIN_ID + ".RECONCILE_TEMPLATE_EDITOR";
  String RECONCILE_SPEC_EDITOR = UIPlugin.PLUGIN_ID + ".RECONCILE_SPEC_EDITOR";
