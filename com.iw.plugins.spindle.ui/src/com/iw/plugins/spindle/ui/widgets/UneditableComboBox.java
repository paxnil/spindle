...
public class UneditableComboBox extends Composite
{
    ...
    public UneditableComboBox(Composite parent, int style)
    {
        ...
        int[] listEvents =
            { SWT.MouseUp, SWT.Selection, SWT.Traverse, SWT.KeyDown, SWT.KeyUp, SWT.FocusIn, SWT.FocusOut };
    ...
    */
    ...
    public Point computeSize(int wHint, int hHint, boolean changed)
    {
        ...
        width = Math.max(wHint, Math.max(labelSize.x + arrowSize.x + 2 * borderWidth, listSize.x + 2));
    ...
    */
    ...
    {
        if (label.isFocusControl() || arrow.isFocusControl() || list.isFocusControl() || popup.isFocusControl())
        {
            return true;
        } else
        {
