...
public class NewTapComponentWizardClassPage extends TapestryWizardPage
{
  ...
  protected void createSpecClassResource(IProgressMonitor monitor) throws InterruptedException, CoreException
  {
    ...
    } else
    {
      ...
      finalSpecClass = factory.createClass(fChooseContainer.getPackageFragmentRoot(), fPackageDialogField.getPackageFragment(),
          fSpecClassDialogField.getTextValue(), fSuperClassDialogField.getType(), fIFaceChooser.getInterfaces(),
          fMakeAbstractField.getCheckBoxValue(), null, monitor);
