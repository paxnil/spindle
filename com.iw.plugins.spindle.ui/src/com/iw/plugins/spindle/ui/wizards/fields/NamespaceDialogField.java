...
public class NamespaceDialogField extends UneditableComboBoxDialogField
{
    ...
    private void populateNamespaces()
    {
        ...
        if (newProject != null)
        {
            ...
            INamespace projectNamespace =
                TapestryArtifactManager.getTapestryArtifactManager().getProjectNamespace(newProject.getProject());
    ...
    public IStatus namespaceChanged()
    {
        ...
        IResourceWorkspaceLocation targetLocation =
            (IResourceWorkspaceLocation) selectedTarget.getSpecificationLocation();
