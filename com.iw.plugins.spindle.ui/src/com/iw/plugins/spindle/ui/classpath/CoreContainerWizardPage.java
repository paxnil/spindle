...
/**
 * Extension to allow a user to associate the default Tapestry Framework with a Java project.
 */
public class CoreContainerWizardPage extends WizardPage implements IClasspathContainerPage
{
