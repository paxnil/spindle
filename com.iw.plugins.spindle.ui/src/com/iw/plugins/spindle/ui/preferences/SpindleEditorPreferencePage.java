 ...
 * All Rights Reserved
 */
public class SpindleEditorPreferencePage
    ...
    implements IWorkbenchPreferencePage, IPropertyChangeListener
{
    ...
    {
        super(UIPlugin.getString("preference-editor-title"), Images.getImageDescriptor("applicationDialog.gif"));
    ...
    public void propertyChange(PropertyChangeEvent event)
    {
        if (event.getProperty().equals(FieldEditor.IS_VALID))
        {
            ...
            {
                setValid(
                    fDisplayTabWidth.isValid() && fAutoActivateContentAssist.isValid() && fPreserveBlankLines.isValid() && fUseTabsForIndentation.isValid());
            } else
            {
                setValid(newValue);
            }
