        ...
        IProblemCollector
{
    ...
    /**
     * Internal structure for mapping positions to some value. The reason for this specific
     * structure is that positions can change over time. Thus a lookup is based on value and not on
     * hash value.
     */
    ...
    public void addProblem(int severity, ISourceLocation location, String message, int code)
    {
        addProblem(severity, location, message, false, code);
    }
