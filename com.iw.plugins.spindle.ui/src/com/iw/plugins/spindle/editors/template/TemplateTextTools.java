...
public class TemplateTextTools extends AbstractTextTools
{
    ...
    private static final String[] TOKENS =
        {
            ITemplateSyntaxConstants.XML_DEFAULT,
            ITemplateSyntaxConstants.XML_TAG,
            ITemplateSyntaxConstants.XML_ATT_NAME,
            ITemplateSyntaxConstants.XML_ATT_VALUE,
            ITemplateSyntaxConstants.XML_ENTITY,
            ITemplateSyntaxConstants.XML_PI,
            ITemplateSyntaxConstants.XML_CDATA,
            ITemplateSyntaxConstants.XML_COMMENT,
            ITemplateSyntaxConstants.XML_DECL,
    ...
    public TemplateTextTools(IPreferenceStore store)
    {
        ...
        fXmlCommentScanner = new SingleTokenScanner(tokens, ITemplateSyntaxConstants.XML_COMMENT);
     ...
     * Is special in that it handles attribute named "jwcid' differently
     * 
