...
public class ChooseResourceProposal implements ICompletionProposal
{
    ...
    private AbstractRootLocation[] roots;
    ...
    private Filter packageExclusionFilter = NEVER_MATCH;
    ...
    {
        this(specEditor, previousCAState, new AbstractRootLocation[]
        { rootObject }, documentOffset, replacementOffset, replacementLength);        
    }

    public ChooseResourceProposal(SpecEditor specEditor, boolean previousCAState,
            AbstractRootLocation[] rootObjects, int documentOffset, int replacementOffset,
            int replacementLength)
    {
        this.previousCAState = previousCAState;
        Assert.isNotNull(specEditor);
        Assert.isNotNull(rootObjects);
        Assert.isTrue(rootObjects.length > 0 && rootObjects.length < 3);
        editor = specEditor;
        roots = rootObjects;
    ...
    public AbstractRootLocation[] getRootLocations()
    {
        return roots;
    }
    ...
    public void setPackageExclusionFilter(Filter filter) {
        packageExclusionFilter = filter;
    }
    
    public Filter getPackageExclusionFilter() {
        return packageExclusionFilter;
    }
