 ...
 * UIPlugin.getDefault().getSpecFileDocumentProvider()
 * 
 * @author glongman@intelligentworks.com
 * @version $Id: SpecFileDocumentProvider.java,v 1.6 2003/12/13 14:43:12
 *          glongman Exp $
 */
public class SpecFileDocumentProvider extends FileDocumentModelProvider
{
   ...
   */
  protected void setDocumentContentWithEmptyCheck(
      IDocument document,
      InputStream contentStream,
      String encoding) throws CoreException
  {
