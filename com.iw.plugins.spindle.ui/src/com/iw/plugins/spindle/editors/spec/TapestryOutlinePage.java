...
public class TapestryOutlinePage extends ContentOutlinePage
{
    ...
    public static void initializePluginDefaults()
    {
    ...
    private TapestryOutlinePage.ToggleAlphaSortAction fToggleAlphaSort =
        new TapestryOutlinePage.ToggleAlphaSortAction();
    private TapestryOutlinePage.ToggleCatSortAction fToggleCatSort = new TapestryOutlinePage.ToggleCatSortAction();

    private Object fSavedInput; // the input might have been posted before the control was created!
    ...
    public class BasicLabelProvider extends LabelProvider
    {
        public String getText(Object obj)
        {
            ...
            if (identifier == null
                || identifier.equals(BaseValidator.DefaultDummyString)
