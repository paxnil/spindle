...
public abstract class Editor extends AbstractDecoratedTextEditor implements IAdaptable, IReconcileWorker
{
  ...
  protected void configureSourceViewerDecorationSupport()
  {
    ...
    fSourceViewerDecorationSupport.setCursorLinePainterPreferenceKeys(Editor.CURRENT_LINE, Editor.CURRENT_LINE_COLOR);
    fSourceViewerDecorationSupport.setMarginPainterPreferenceKeys(Editor.PRINT_MARGIN, Editor.PRINT_MARGIN_COLOR,
  ...
  protected ISourceViewer createSourceViewer(Composite parent, IVerticalRuler verticalRuler, int styles)
  {
    ...
    ISourceViewer viewer = new SourceViewer(parent, verticalRuler, fOverviewRuler, isOverviewRulerVisible(), styles);
