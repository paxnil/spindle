...
public class CSSMergeViewer extends TextMergeViewer {
	...
	protected void configureTextViewer(TextViewer textViewer) {
		...
		textTools = plugin.getCSSTextTools();

		if (textViewer instanceof SourceViewer) {
			SourceViewer sourceViewer = (SourceViewer) textViewer;
			sourceViewer.configure(new CSSConfiguration(textTools));
		}
	...
	protected IDocumentPartitioner getDocumentPartitioner() {
		return textTools.createCSSPartitioner();
	}
	...
	public String getTitle() {
		return XMLPlugin.getResourceString("CSSMergeViewer.title"); //$NON-NLS-1$
	}
