...
public class DOMElementSourceLocationInfo implements ISourceLocationInfo
{
    ...
    public DOMElementSourceLocationInfo(String elementName, ElementXMLEventInfo eventInfo,
