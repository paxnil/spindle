...
package com.iw.plugins.spindle.core.parser.dom.validator;
 ...
 * generic validator! Uses an IProblemCollector, but does not manage the lifecycle of it. Assumes
 * the provider of the collector will manage it. Assumes documents provided to it are well-formed!
 * 
...
public class DOMValidator implements IProblemCollector
{
    ...
    static
    {
        ...
        try
        {
            ...
            publicId = SpecificationParser.TAPESTRY_DTD_4_0_PUBLIC_ID;
            ...
            DTDS.put(publicId, new DTDParser(new InputStreamReader(source.getByteStream()),
                    SpecificationParser.TAPESTRY_DTD_4_0_PUBLIC_ID, debug).parse());
