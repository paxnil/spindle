...
public class DTDElement implements DTDOutput
{
  ...
  public void write(PrintWriter out) throws IOException
  {
    ...
    /*
     * if (attributes.size() > 0) { out.print(" <!ATTLIST "); out.println(name);
     * TreeMap tm=new TreeMap(attributes); Collection values=tm.values();
     * Iterator iterator=values.iterator(); while (iterator.hasNext()) {
     * out.print(" "); DTDAttribute attr = (DTDAttribute) iterator.next();
     * attr.write(out); if (iterator.hasNext()) out.println(); else
     * out.println(">"); } }
     */
  }
