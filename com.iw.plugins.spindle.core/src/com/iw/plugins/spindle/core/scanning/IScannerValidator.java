...
/**
 * Validators used by Scanners to find problems in the Tapestry artifacts they
 * process
 * 
...
public interface IScannerValidator
{
  ...
  /**
   * Scanners report the problems they find to the problem collector registered
  ...
  /**
   * A Scanner calls this method to validate all the aspects of an
   * AssetSpecification that it has just processed
   * 
  ...
  /**
   * A Scanner calls this method to validate all the aspects of an
   * ConatinedComponent that it has just processed
   * 
  ...
  public boolean validateContainedComponent(
      ...
      ISourceLocationInfo node) throws ScannerException;
  ...
  /**
   * 
   * A Scanner calls this method to verify that a perl pattern matches the
   * supplied value
   * 
  ...
  /**
   * 
   * A Scanner calls this method to determine if a resource exists in the
   * project
   * 
  ...
  /**
   * A Scanner calls this to determine if the location of a Tapestry library
   * exists in the project
   * 
   * If the spec declaring the library is on the classpath, the path is resolved
