...
public class ComponentScanner extends SpecificationScanner
{
    ...
    protected void scanBean(IComponentSpecification specification, Node node) throws ScannerException
    {
        ...
        BeanLifecycle lifecycle = (BeanLifecycle) SpecificationScanner.TYPE_CONVERSION_MAP.get(lifecycleString);
        ...
        throws ScannerException
    {
        ...
        // no point in making revalidatable - error state would only change if the file changed!
    ...
    protected void scanComponent(IComponentSpecification specification, Node node) throws ScannerException
    {
        ...
        // all below is not revalidatable - error state would only change if the file changed!
        ...
        PluginContainedComponent c = (PluginContainedComponent) fSpecificationFactory.createContainedComponent();
        c.setType(type);
        c.setCopyOf(copyOf);
    ...
    protected void scanParameter(IComponentSpecification specification, Node node) throws ScannerException
    {
        ...
        PluginParameterSpecification param =
            (PluginParameterSpecification) fSpecificationFactory.createParameterSpecification();
    ...
    protected void scanPropertySpecification(IComponentSpecification spec, Node node) throws ScannerException
    {
        ...
        PluginPropertySpecification ps =
            (PluginPropertySpecification) fSpecificationFactory.createPropertySpecification();
