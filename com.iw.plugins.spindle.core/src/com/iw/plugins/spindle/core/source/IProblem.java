...
public interface IProblem
{
  ...
  /**
   * An integer value indicating where a problem ends. This attribute is
  ...
  /**
   * An integer value indicating where a problem starts. This attribute is
   * zero-relative and inclusive.
   * 
   * @return a zero-relative integer
   */
  ...
  /**
   * An integer value indicating the line number for a text marker. This
   * attribute is 1-relative.
   * 
  ...
  /**
   * A String corresponding to the Eclipse Marker Type Used when converting
   * IProblems into Markers
   */
